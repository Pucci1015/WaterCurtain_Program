            ...
            if ( subNowPage === 1 ) {
                if ( subCode === 6 ) { //f6
                    ...
                    function parLightNumberSM5() {
                        ...
                        for ( var i = 1 ; i <= 8 ; i++ ) parLightColorFadeChange(i,255,80,120,nowTime[0],parLightFadeTime,parLightSetInterval);
                    }
        ...
        if ( mainNowPage === 1 ) {
                if ( key === 'f' ) {
                    ...
                    movingLightSetTimeout[0] = setTimeout( function() {
                        ...
                        function movingLightNumberGATARI4_1() {
                            ...
                            if ( nowTime[0] <= movingLightAngleFadeTime ) {
                                ...
                                movingLightAngleFadeChange(2,2,-50,40,movingLightAngleFadeTime,nowTime[0]);
                                movingLightAngleFadeChange(2,3,50,40,movingLightAngleFadeTime,nowTime[0]);
                    ...
                    movingLightSetTimeout[1] = setTimeout( function() {
                        ...
                        function movingLightNumberGATARI4_2() {
                            ...
                            if ( nowTime[0] <= movingLightColorFadeTime + 100 ) {
                                for ( var i = 2 ; i <= movingLightOutsideNumber ; i++ ) movingLightColorChange(2,i,255,255,255,1,movingLightColorFadeTime,nowTime[0],1);
                            } else {
                                clearInterval(movingLightSetInterval[2]);
                            }
                ...
                if ( key === 'f' ) {
                    ...
                    function waterLightNumberGATARI4() {
                        ...
                        for ( var i = 1 ; i <= waterLightNumber ; i++ ) {
                            waterLightColorChange(i,240,180,255,nowTime[0],fadeTime,0,waterLightSetInterval);
                        }
                    }
                ...
                if ( subCode === 6 ) { //f6
                    ...
                    function logoboardLightNumberGATARI1() {
                        ...
                        for ( var i = 1 ; i <= logoboardLightNumber ; i++ ) {
                            ...
                            if ( j <= 6 ) logoboardLightColor = [ 255 , 50 , 180 , 100 ];
                            else if ( j <= 18 ) logoboardLightColor = [ 255 , 255 , 100 , 255 ];
                            else if ( j <= 21 ) logoboardLightColor = [ 255 , 50 , 180 , 100 ];
                            else logoboardLightColor = [ 255 , 255 , 100 , 255 ];
