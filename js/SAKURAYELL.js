...
jsSetting("SAKURAYELL",2025,"春","SAKURA YELL","SAKURA YELL",1,1,SAKURAYELL_Music,"https://script.google.com/macros/s/AKfycbyZMIkVOLhampO8Q4Va-h_Ls5TDMn4oPUfOF87_3hzBtS4NDkMvRNVCfwsN9yhyx8sVyw/exec","桜語り",2,1,0,0,2200,3.5,1);
        ...
        if ( dnNowSelect === 0 ) {
                ...
                if ( key === 'f' ) {
                    ...
                    waterLightSetTimeout[0] = setTimeout( function() {
                        ...
                        function waterLightNumberSY1_1() {
                            ...
                            let waterLightBasicColor = [ [ 220 , 150 , 255 ] , [ 180 , 50 , 255 ] ];
                    ...
                    logoboardLightSetTimeout[0] = setTimeout(function() {
                        ...
                        function logoboardLightNumberSY2_1() {
                            ...
                            let logoboardChangeTime = 300;
                            let logoboardRepeatTimeSplit = logoboardRepeatTime / 4;
                            let logoboardBasicColor = [ [ 255 , 100 , 255 , 50 ] , [ 255 , 50 , 150 , 100 ] ];
            
                            for ( var i = 1 ; i <= logoboardLightNumber ; i++ ) {
                                let logoboardColor = [];
                                let logoboardLapTimeSplit;
                                if ( i <= 24 ) logoboardLapTimeSplit = logoboardRepeatTimeSplit * Math.trunc( ( i - 1 ) % 12 / 3 );
                                else logoboardLapTimeSplit = logoboardRepeatTimeSplit * Math.trunc( ( 11 - ( i - 1 ) % 12 ) / 3 );

                                let logoboardJudgeTime = ( nowTime[1] + logoboardLapTimeSplit ) % logoboardRepeatTime;

                                if ( logoboardJudgeTime < logoboardChangeTime ) {
                                    for ( var k = 0 ; k < 4 ; k++ ) logoboardColor[k] = logoboardBasicColor[0][k] + ( logoboardBasicColor[1][k] - logoboardBasicColor[0][k] ) / logoboardChangeTime * logoboardJudgeTime ;
                                } else if ( logoboardJudgeTime < logoboardChangeTime * 2 ) {
                                    for ( var k = 0 ; k < 4 ; k++ ) logoboardColor[k] = logoboardBasicColor[1][k] + ( logoboardBasicColor[0][k] - logoboardBasicColor[1][k] ) / logoboardChangeTime * ( logoboardJudgeTime - logoboardChangeTime ) ;
                                } else {
                                    for ( var k = 0 ; k < 4 ; k++ ) logoboardColor[k] = logoboardBasicColor[0][k];
                                }

                                logoboardLightAnimateChange(i,logoboardColor[0],logoboardColor[1],logoboardColor[2],logoboardColor[3],1,logoboardLightFadeTime,nowTime[0],200);
                            }
                        }
                    ...
                    movingLightSetTimeout[1] = setTimeout( function() {
                        ...
                        function movingLightNumberSY1_3() {
                            ...
                            for ( var i = 1 ; i <= 3 ; i++ ) {
                                ...
                                for ( var j = 1 ; j <= 4 ; j++ ) movingLightGradientColorChange(2,j,255,0,150,0,255,220,200,80,movingLightDegree,-1,0,0,i);
                            }                            
                    ...
                    ledSetTimeout[13] = setTimeout( function() {
                        ...
                        function ledNumberSY2_10() {
                            ...
                            let ledRepeatTime = 2000;
                            let ledBasicColor = [ [ 255 , 200 , 255 ] , [ 255 , 80 , 200 ] ];
                            let ledRepeatTimeSplit = ledRepeatTime / 2;
                            let ledLapTimeSplit = ledRepeatTime / 50;
                    ...
                    ledSetTimeout[14] = setTimeout( function() {
                        ...
                        function ledNumberSY2_11() {
                            ...
                            let ledBasicColor1 = [ 220 , 255 , 0 ];
                            let ledBasicColor2 = [ [ 200 , 50 , 255 ] , [ 255 , 50 , 200 ] ];
                            let ledRepeatTimeSplit = ledRepeatTime / 6;
                            let ledLapTimeSplit = ledRepeatTime * 2 / ledNumberInside;
                            ...
                            for ( var i = 1 ; i <= ledNumberInside ; i++ ) {
                                ...
                                for ( var l = 0 ; l < 2 ; l++ ) {
                                    if ( ledJudgeTime < ledRepeatTimeSplit * ( l * 3 + 1 ) ) {
                                        ...
                                        for ( var k = 0 ; k < 3 ; k++ ) ledColor[k] = ledBasicColor1[k] + ( ledBasicColor2[ ( l + 1 ) % 2 ][k] - ledBasicColor1[k] ) / ledRepeatTimeSplit * ( ledJudgeTime - ledRepeatTimeSplit * ( l * 3 + 1 ) );
                                        break;
                                    } else if ( ledJudgeTime < ledRepeatTimeSplit * ( ( l + 1 ) * 3 ) ) {
                            ...
                            let ledBasicColor = [ [ 180 , 240 , 255 ] , [ 255 , 0 , 180 ] ];
                    ...
                    logoboardLightSetTimeout[0] = setTimeout(function() {
                        ...
                        function logoboardLightNumberSY4_1() {
                            ...
                            for ( var i = 1 ; i <= logoboardLightNumber ; i++ ) {
                                ...
                                else if ( j <= 12 ) logoboardLightColor = [ 255 , 0 , 150 , 100 ];
                                else if ( j <= 18 ) logoboardLightColor = [ 0 , 255 , 0 , 100 ];
                                else logoboardLightColor = [ 255 , 0 , 220 , 100 ];
                    ...
                    logoboardLightSetTimeout[1] = setTimeout(function() {
                        ...
                        function logoboardLightNumberSY4_2() {
                            ...
                            let logoboardBasicColor = [ [ 255 , 0 , 255 , 150 ] , [ 255 , 0 , 200 , 150 ] , [ 50 , 255 , 100 , 150 ] , [ 255 , 0 , 200 , 150 ] , [ 255 , 0 , 255 , 150 ] , [ 50 , 150 , 100 , 50 ] ];
                            ...
                            for ( var i = 1 ; i <= logoboardLightNumber ; i++ ) {
                                ...
                                logoboardLightAnimateChange(i,logoboardColor[0],logoboardColor[1],logoboardColor[2],logoboardColor[3],1,logoboardLightFadeTime,nowTime[0],150);
                            }
                        }
                    },logoboardLightDelayTime[1]);
                    ...
                    movingLightSetTimeout[21] = setTimeout( function() {
                        ...
                        function movingLightNumberSY2_26() {
                            ...
                            let movingLightAngleLapDegSplit = [ 90 , 180 , 240 , 90 ];
                            let angleXYRadius = 180;
                            let angleXYCenter = 0;
                            let angleZRadius = 45;
                            let angleZCenter = 60;
                    ...
                    ledSetTimeout[1] = setTimeout( function() {
                        ...
                        function ledNumberSY3_1() {
                            ...
                            let nowTime = nowTimeGet(startTime+ledSetTimeoutDelay[1],ledFadeTime,ledUseNumber,ledSetInterval[1],ledMyNumber,ledUseChildrenNumber,ledChildrenMyNumber);
                            let ledRepeatTime = 3000;
                            let ledBasicColor = [ [ 255 , 220 , 0 ] , [ 255 , 120 , 0 ] ];
                            let ledRepeatTimeSplit = ledRepeatTime / 2;
                    ...
                    ledSetTimeout[8] = setTimeout( function() {
                        ...
                        function ledNumberSY4_7() {
                            ...
                            let ledBasicColor = [ [ 255 , 255 , 0 ] , [ 255 , 120 , 0 ] , [ 255 , 255 , 255 ] , [ 100 , 255 , 255 ] ];
                            let ledRepeatTimeSplit = ledRepeatTime / 4;
                            let ledLapTimeSplit = ledRepeatTime * 1.5 / ledNumberInside;
                    ...
                    ledSetTimeout[13] = setTimeout( function() {
                        ...
                        function ledNumberSY4_11() {
                            ...
                            let ledBasicColor1 = [ 255 , 255 , 255 ];
                            let ledBasicColor2 = [ [ 200 , 150 , 255 ] , [ 255 , 0 , 200 ] , [ 255 , 255 , 0 ] , [ 0 , 255 , 0 ] , [ 0 , 255 , 255 ]  ];
                            let ledRepeatTimeSplit = ledRepeatTime / 10;
                            let ledLapTimeSplit = ledRepeatTime / ledNumberInside;
                    ...
                    ledSetTimeout[14] = setTimeout( function() {
                        ...
                        function ledNumberSY4_12() {
                            ...
                            let ledBasicColor1 = [ 255 , 255 , 255 ];
                            let ledBasicColor2 = [ [ 255 , 255 , 0 ] , [ 0 , 255 , 200 ] , [ 0 , 255 , 255 ] , [ 255 , 100 , 0 ] ];
                    ...
                    /***** 水中照明 SY5 *****/
                    let waterLightMyNumber = waterLightSetting();
                    let waterLightSetInterval = setInterval(waterLightNumberSY5);

                    function waterLightNumberSY5() {
                        let waterLightFadeTime = 2000;
                        let nowTime = nowTimeGet(startTime,waterLightFadeTime,waterLightUseNumber,waterLightSetInterval,waterLightMyNumber);
                    ...
                    movingLightSetTimeout[18] = setTimeout( function() {
                        ...
                        function movingLightNumberSY4_25() {
                            ...
                            let movingLightRotateRepeatTime = 30000;
                            let movingLightRotateDeg = -360 / movingLightRotateRepeatTime * ( nowTime[0] % movingLightRotateRepeatTime );
                            
                            for ( var i = 1 ; i <= movingLightInsideNumber ; i++ ) movingLightTripleRotateChange(1,i,movingLightRotateDeg+90*(5-i));
                    ...
                    movingLightSetTimeout[19] = setTimeout( function() {
                        ...
                        movingLightSetInterval[26] = setInterval(movingLightNumberSY4_26);

                        function movingLightNumberSY4_26() {
                            let nowTime = nowTimeGet(startTime+movingLightSetTimeoutDelay[19],0,movingLightUseNumber,movingLightSetInterval[26],movingLightMyNumber);
                    ...
                    waterLightSetTimeout[0] = setTimeout( function() {
                        let waterLightChildrenMyNumber = waterLightSetting(waterLightMyNumber);
                        waterLightSetInterval[1] = setInterval(waterLightNumberSY6_1);

                        function waterLightNumberSY6_1() {
                            ...
                            let waterLightBasicColor = [ [ 150 , 0 , 255 ] , [ 0 , 200 , 255 ] , [ 255 , 255 , 0 ] , [ 255 , 0 , 150 ] ];
                    ...
                    waterLightSetTimeoutDelay[1] = 22000;
                    waterLightSetTimeout[1] = setTimeout( function() {
                        let waterLightChildrenMyNumber = waterLightSetting(waterLightMyNumber);
                        waterLightSetInterval[2] = setInterval(waterLightNumberSY6_2);

                        function waterLightNumberSY6_2() {
                    ...
                    logoboardLightSetTimeout[0] = setTimeout(function() {
                        ...
                        function logoboardLightNumberSY7_1() {
                            ...
                            let logoboardBasicColor = [ [ 100 , 220 , 100 ] , [ 255 , 100 , 120 ] , [ 50 , 50 , 255 ] ];
                            ...
                            for ( var i = 1 ; i <= logoboardLightNumber ; i++ ) {
                                ...
                                logoboardLightAnimateChange(i,logoboardColor[0],logoboardColor[1],logoboardColor[2],-1,1,logoboardLightFadeTime,nowTime[0],255);
                            }
                        }
                    ...
                    movingLightSetTimeoutDelay[21] = 0;
                    movingLightSetTimeout[21] = setTimeout( function() {
                        clearInterval(movingLightSetInterval[9]);
                        clearInterval(movingLightSetInterval[11]);
                        clearInterval(movingLightSetInterval[13]);
            ...
            if ( subNowPage === 1 ) {
                if ( subCode === 6 ) {
                    ...
                    logoboardLightSetTimeout[0] = setTimeout(function() {
                        let logoboardLightMyNumber = logoboardLightSetting(0);
                        let logoboardLightFadeTime = 1000//8000;
                        ...
                        function logoboardLightNumberSY1_1() {
                            ...
                            for ( var i = 1 ; i <= logoboardLightNumber ; i++ ) {
                                ...
                                if ( i <= 6 ) logoboardLightColor = [ 255 , 0 , 180 , 80 ];
                                else if ( i <= 12 ) logoboardLightColor = [ 0 , 50 , 20 , 255 ];
                                else if ( i <= 24 ) logoboardLightColor = [ 200 , 80 , 180 , 255 ];
                                else if ( i <= 36 ) logoboardLightColor = [ 255 , 50 , 255 , 80 ];
                                else if ( i <= 42 ) logoboardLightColor = [ 0 , 50 , 20 , 255 ];
                                else logoboardLightColor = [ 180 , 50 , 180 , 255 ];
                    ...
                    logoboardLightSetTimeout[1] = setTimeout(function() {
                        ...
                        function logoboardLightNumberSY1_2() {
                            ...
                            for ( var i = 1 ; i <= logoboardLightNumber ; i++ ) {
                                ...
                                if ( i <= 6 ) logoboardLightColor = [ 240 , 80 , 255 , 100 ];
                                else if ( i <= 12 ) logoboardLightColor = [ 255 , 100 , 50 , 255 ];
                                else if ( i <= 18 ) logoboardLightColor = [ 255 , 150 , 240 , 255 ];
                                else if ( i <= 24 ) logoboardLightColor = [ 200 , 80 , 180 , 255 ];
                                else if ( i <= 30 ) logoboardLightColor = [ 255 , 50 , 255 , 150 ];
                                else if ( i <= 36 ) logoboardLightColor = [ 255 , 50 , 255 , 80 ];
                                else if ( i <= 42 ) logoboardLightColor = [ 255 , 50 , 20 , 255 ];
                                else logoboardLightColor = [ 220 , 50 , 200 , 255 ];
                    ...
                    function logoboardLightNumberSY6() {
                        ...
                        for ( var i = 1 ; i <= logoboardLightNumber ; i++ ) {
                            ...
                            if ( j <= 3 ) logoboardLightColor = [ 255 , 255 , 50 , 255 ];
                            else if ( j <= 12 ) logoboardLightColor = [ 220 , 200 , 255 , 255 ];
                            else if ( j <= 21 ) logoboardLightColor = [ 120 , 120 , 255 , 50 ];
                            else logoboardLightColor = [ 255 , 255 , 50 , 255 ];
                    ...
                    function logoboardLightNumberSY8() {
                        ...
                        for ( var i = 1 ; i <= logoboardLightNumber ; i++ ) {
                            ...
                            else if ( j % 2 === 1 ) logoboardLightColor = [ 255 , 100 , 150 , 200 ];
                            else logoboardLightColor = [ 255 , 50 , 150 , 100 ];
            ...
            if ( mainNowPage === 1 ) {
                if ( key === 'f' ) {
                    ...
                    function waterLightNumberGATARI2() {
                        ...
                        for ( var i = 1 ; i <= waterLightNumber ; i++ ) waterLightColorChange(i,180,80,255,nowTime[0],fadeTime,0,waterLightSetInterval);
                    }
                    ...
                    function ledNumber89() {
                        ...
                        let ledRepeatTimeSplit = ledRepeatTime / 4;
                        let ledBasicColor = [ [ 240 , 200 , 255 ] , [ 255 , 255 , 240 ] , [ 220 , 255 , 200 ] , [ 255 , 220 , 200 ] ];
                        let nowTime = nowTimeGet(startTime,ledFadeTime,ledUseNumber,ledSetInterval,ledMyNumber);
                        let ledLapTimeSplit = ledRepeatTime * 4 / ledNumberInside;
                    ...
                    movingLightSetTimeout[0] = setTimeout( function() {
                        ...
                        function movingLightNumberGATARI5_1() {
                            ...
                            if ( nowTime[0] <= movingLightColorFadeTime ) {
                                for ( var i = 1 ; i <= movingLightInsideNumber ; i++ ) movingLightColorChange(1,i,-1,-1,-1,0,movingLightColorFadeTime,nowTime[0]);
                                for ( var i = 2 ; i <= movingLightInsideNumber ; i++ ) movingLightAngleChange(1,i,0,50,movingLightAngleFadeTime,nowTime[0]);
                                movingLightAngleChange(1,1,0,-40,movingLightAngleFadeTime,nowTime[0]);
                    ...
                    function ledNumber54() {
                        ...
                        for ( var i = 1 ; i <= ledNumberInside ; i++ ) ledColorChange(1,i,250,255,220,nowTime[0],ledFadeTime,0,ledSetInterval);
            ...
            if ( subNowPage === 1 ) {
                if ( subCode === 6 ) { 
                    ...
                    function logoboardLightNumberGATARI1() {
                        ...
                        for ( var i = 1 ; i <= logoboardLightNumber ; i++ ) {
                            ...
                            switch ( j ) {
                                ...
                                case 5:
                                case 7:
                                    logoboardLightColor = [ 80 , 0 , 50 , 255 ];
                                    break;
                                default:
                    ...
                    function parLightNumberGATARI1() {
                        ...
                        for ( var i = 1 ; i <= 8 ; i++ )parLightColorFadeChange(i,255,100,255,nowTime[0],parLightFadeTime,parLightMyNumber,parLightSetInterval);                   
                    }
