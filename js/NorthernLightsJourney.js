        ...
        if ( dnNowSelect === 0 ) {
            if ( mainNowPage === 1 ) {
                if ( key === 'f' ) {
                    ...
                    /***** ムービングライト NLJ2 *****/
                    let movingLightSetTimeout = [], movingLightSetTimeoutDelay = [], movingLightSetInterval = [];
                    let movingLightMyNumber = movingLightSetting(movingLightSetTimeout,0,startTime,210800);
                    ...
                    movingLightSetTimeout[6] = setTimeout( function() {
                        ...
                        function movingLightNumberNLJ2_10() {
                            ...
                            for ( var i = 1 ; i <= 4 ; i++ ) movingLightRotateChange(2,i,( (-1) ** i ) * movingLightRotateDeg);
                    ...
                    /***** ムービングライト NLJ3 *****/
                    let movingLightSetTimeout = [], movingLightSetTimeoutDelay = [], movingLightSetInterval = [];
                    let movingLightMyNumber = movingLightSetting(movingLightSetTimeout,0,startTime,165800);
                    ...
                    ledSetTimeout[6] = setTimeout( function() {
                        ...
                        function ledNumberNLJ4_6() {
                            ...
                            if ( ledJudgeTime < 550 ) {
                                ...
                                for ( var k = 0 ; k < 3 ; k++ ) ledColor[k] = ledBasicColor[3][k];
                            }
                    ...
                    ledSetTimeout[9] = setTimeout( function() {
                        ...
                        function ledNumberNLJ4_3() {
                            ...
                            let nowTime = nowTimeGet(startTime+ledSetTimeoutDelay[9],5000,ledUseNumber,ledSetInterval[3],ledMyNumber,ledUseChildrenNumber,ledChildrenMyNumber);
                            let ledRepeatTime = 5000;
                    ...
                    /***** ムービングライト NLJ4 *****/
                    let movingLightSetTimeout = [], movingLightSetTimeoutDelay = [], movingLightSetInterval = [];
                    let movingLightMyNumber = movingLightSetting(movingLightSetTimeout,0,startTime,211500);
            ...
            if ( mainNowPage === 1 ) {
                if ( key === 'f' ) {
                    ...
                    function waterLightNumberBC1() {
                        ...
                        for ( var i = 1 ; i <= waterLightNumber ; i++ ) waterLightColorChange(i,50,150,255,nowTime[0],fadeTime,0,waterLightSetInterval);
                    }
                    ...
                    function waterLightNumberBC2() {
                        ...
                        for ( var i = 1 ; i <= waterLightNumber ; i++ ) waterLightColorChange(i,0,200,255,nowTime[0],fadeTime,0,waterLightSetInterval);
                    }
                    ...
                    function waterLightNumberBC3() {
                        ...
                        for ( var i = 1 ; i <= waterLightNumber ; i++ ) waterLightColorChange(i,0,100,255,nowTime[0],fadeTime,0,waterLightSetInterval);
                    }
                    ...
                    function waterLightNumberBC4() {
                        ...
                        for ( var i = 1 ; i <= waterLightNumber ; i++ ) waterLightColorChange(i,0,220,255,nowTime[0],fadeTime,0,waterLightSetInterval);
                    }
                    ...
                    function waterLightNumberBC5() {
                        ...
                        for ( var i = 1 ; i <= waterLightNumber ; i++ ) waterLightColorChange(i,50,120,255,nowTime[0],fadeTime,0,waterLightSetInterval);
                    }
