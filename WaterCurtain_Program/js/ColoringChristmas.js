jsSetting("ColoringChristmas","Coloring Christmas",2,1,/*2,1,*/0,0,2200);
                ...
                if ( key === 'f' ) {
                    ...
                    movingLightSetTimeout[1] = setTimeout( function() {
                        ...
                        function movingLightNumberCC2_2() {
                            ...
                            if ( nowTime[0] <= movingLightAngleFadeTime ) {
                                for ( var i = 1 ; i <= 3 ; i++ ) movingLightAngleFadeChange(1,i,0,-20,movingLightAngleFadeTime,nowTime[0]);
            ...
            if ( mainNowPage === 1 ) {
                if ( key === 'f' ) {
                    ...
                    function ledNumber118() {
                        ...
                        for ( var i = 1 ; i <= ledNumberInside ; i++ ) ledColorChange(1,i,255,0,80,nowTime[0],ledFadeTime,0,ledSetInterval);
    
                        for ( var i = 1 ; i <= ledNumberOutside ; i++ ) ledColorChange(2,i,255,0,80,nowTime[0],ledFadeTime,0,ledSetInterval);
                    ...
                    function waterLightNumberBCP2() {
                        ...
                        let waterLightColor = [];
                        let waterLightBasicColor = [ [ 0 , 180 , 255 ] , [ 0 , 0 , 255 ] ];
                    ...
                    for ( var i = 1 ; i <= movingLightOutsideNumber ; i++ ) {
                        movingLightPictureChange(2,i,14,80,100);
                    }
                    ...
                    movingLightSetTimeout[0] = setTimeout( function() {
                        ...
                        function movingLightNumberBCP3_1() {
                            ...
                            if ( nowTime[0] <= movingLightColorFadeTime ) {
                                ...
                                for ( var i = 1 ; i <= movingLightOutsideNumber ; i++ ) {
                                    movingLightColorChange(2,i,255,255,0,1,movingLightAngleFadeTime,nowTime[0]);
                                    movingLightAngleFadeChange(2,i,0,85,movingLightAngleFadeTime,nowTime[0]);
                                }
                            }
    
                            let movingLightRotateDeg = 360 / 100000 * nowTime[0];
                ...
                if ( key === 'f' ) {
                    ...
                    function ledNumber67() {
                        ...
                        for ( var i = 1 ; i <= ledNumberInside ; i++ ) ledColorChange(1,i,0,255,80,nowTime[0],ledFadeTime,0,ledSetInterval);
        
                        for ( var i = 1 ; i <= ledNumberOutside ; i++ ) ledColorChange(2,i,0,255,80,nowTime[0],ledFadeTime,0,ledSetInterval);
                ...
                if ( subCode === 6 ) { //f6
                    ...
                    function logoboardLightNumberBCP1() {
                        ...
                        for ( var i = 1 ; i <= logoboardLightNumber ; i++ ) {
                            ...
                            if ( j % 9 < 3 ) logoboardLightColor = [ 255 , 0 , 100 , 100 ];
                            else logoboardLightColor = [ 255 , 255 , 100 , 150 ];
                    ...
                    function logoboardLightNumberBCP1() {
                        let nowTime = nowTimeGet(startTime,0,logoboardLightUseNumber[0],logoboardLightSetInterval,logoboardLightMyNumber);
                        for ( var i = 1 ; i <= logoboardLightNumber ; i++ ) logoboardLightFadeChage(i,255,255,0,0,1,logoboardLightFadeTime,nowTime[0],logoboardLightSetInterval,0);
                    }
